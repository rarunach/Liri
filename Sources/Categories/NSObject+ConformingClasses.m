...
@interface NSObject (ConformingClassesPrivate)
@end

@implementation NSObject (ConformingClassesPrivate)

#pragma mark -
#pragma mark NSObject (ConformingClassesPrivate)
...
@implementation NSObject (ConformingClasses)

#pragma mark -
#pragma mark NSObject (ConformingClasses)
