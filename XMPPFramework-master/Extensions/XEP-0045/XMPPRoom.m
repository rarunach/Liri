...
- (void)joinRoomUsingNickname:(NSString *)desiredNickname history:(NSXMLElement *)history password:(NSString *)passwd
{
	dispatch_block_t block = ^{ @autoreleasepool {
		...
		XMPPLogVerbose(@"%@[%@] - %@", THIS_FILE, roomJID, THIS_METHOD);
        ...
        XMPPLogVerbose(@"%@[%@] - %@,state=%hu", THIS_FILE, roomJID, THIS_METHOD,state);
...
{
	// Ramani: set the room subject temporarily
...
- (void)xmppStreamDidAuthenticate:(XMPPStream *)sender
{
    ...
    XMPPLogVerbose(@"%@:%@[%@] -Resetting state=%hu",THIS_FILE,THIS_METHOD,roomJID,state);
...
- (void)xmppStream:(XMPPStream *)sender didReceivePresence:(XMPPPresence *)presence
{
    ...
    XMPPLogVerbose(@"%@[%@] -isAvailable=%@",THIS_FILE,roomJID,(isAvailable? @"YES": @"NO"));
    XMPPLogVerbose(@"%@[%@] -presenceType=%@",THIS_FILE,roomJID,presenceType);
    XMPPLogVerbose(@"%@[%@] -state=%hu",THIS_FILE,roomJID,state);
